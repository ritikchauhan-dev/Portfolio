...
const WrapButton: React.FC<WrapButtonProps> = ({
  ...
  return (
    <div onClick={handledownload} className="flex w-fit items-center ">
      {href ? (
        <Link href={href}>
          <div
          ...
          >
            <div className="border border-[#3B3A3A]   h-[43px] rounded-full flex items-center justify-center text-white">
        ...
        >
          <div className="border border-[#3B3A3A] bg-cyan-500  h-[43px] rounded-full flex items-center justify-center text-black-500 px-4">
